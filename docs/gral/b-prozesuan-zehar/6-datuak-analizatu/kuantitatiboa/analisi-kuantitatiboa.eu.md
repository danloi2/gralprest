...
!!! tip "Adibide **lagina** (GRAL): 30 Ikasleren Notak"
    Ikastetxe bateko 30 ikasleren notak **lagina** dira, ikastetxe osoaren emaitzak estimatzeko.
    
    {important} Ideia nagusia
    **Populazioa**ren eta **Lagina**ren arteko erlazioa:
    - **Populazioa** → **guztia**, zuzeneko informazio guztia  
    - **Lagina** → **zati bat**, praktiko eta aztertzeko erraza, ondorioak ateratzeko erabiltzen dena
