...
export function parseIndexLine(line, { single, pair, triple, see, seealso }, vfile, node) {
...
export function splitEntryValue(entry) {
...
export function createIndexEntries({ single, pair, triple, see, seealso }, vfile, node) {
    const entries = [];
