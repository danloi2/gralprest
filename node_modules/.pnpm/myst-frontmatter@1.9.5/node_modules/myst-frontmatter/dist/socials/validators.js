import { defined, incrementOptions, validateObjectKeys, validateString, validateUrl, validationError, validateDomain, } from 'simple-validators';
 ...
 */
export function validateMastodon(input, opts) {
 ...
 */
export function validateBluesky(input, opts) {
    const value = validateString(input, opts);
    if (value === undefined)
        return undefined;
    // Username
 ...
 */
export function validateTwitter(input, opts) {
    const value = validateString(input, opts);
    if (value === undefined)
        return undefined;
    let match;
 ...
 */
export function validateTelegram(input, opts) {
    const value = validateString(input, opts);
    if (value === undefined)
        return undefined;
    let match;
 ...
 */
export function validateYouTube(input, opts) {
    const value = validateString(input, opts);
    if (value === undefined)
        return undefined;
    // URL
 ...
 */
export function validateGitHub(input, opts) {
    const value = validateString(input, opts);
    if (value === undefined)
        return undefined;
    let match;
...
export function validateSocialLinks(input, opts, output) {
    const value = output
        ? input
