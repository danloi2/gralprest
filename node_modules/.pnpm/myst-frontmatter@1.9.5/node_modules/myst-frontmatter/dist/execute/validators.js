import { defined, incrementOptions, validateObjectKeys, validateString, validateBoolean, validateList, } from 'simple-validators';
const EXECUTE_KEYS = ['skip', 'depends_on_env', 'cache'];
/**
 * Validate Execute object
 */
export function validateExecute(input, opts) {
