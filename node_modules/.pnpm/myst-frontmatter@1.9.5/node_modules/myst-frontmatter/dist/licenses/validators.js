import { validationWarning, defined, incrementOptions, validateObjectKeys, validateString, validateUrl, validateBoolean, } from 'simple-validators';
...
const ID_LICENSE_LOOKUP = Object.fromEntries(Object.entries(LICENSES).map(([key, value]) => {
    return [key, { id: key, ...value, url: createURL(key, value.CC, value.osi) }];
}));
const URL_ID_LOOKUP = Object.fromEntries(Object.values(ID_LICENSE_LOOKUP)
 ...
 */
export function simplifyLicenses(licenses) {
