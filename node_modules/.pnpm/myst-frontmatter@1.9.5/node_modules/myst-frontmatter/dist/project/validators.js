import { defined, incrementOptions, validateBoolean, validateDate, validateList, validateNumber, validateObject, validateObjectKeys, validateString, validateUrl, validationError, validationWarning, } from 'simple-validators';
...
export function validateProjectAndPageFrontmatterKeys(value, opts) {
    ...
    if (defined(value.abbreviations)) {
        ...
        const abbreviations = Object.fromEntries(Object.entries(validateObject(value.abbreviations, abbreviationsOpts) ?? {})
            .map(([k, v]) => {
