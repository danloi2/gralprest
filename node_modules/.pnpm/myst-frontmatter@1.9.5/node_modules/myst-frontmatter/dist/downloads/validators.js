import { defined, incrementOptions, validateBoolean, validateList, validateObjectKeys, validateString, validationError, } from 'simple-validators';
...
export function validateDownload(input, opts) {
...
export function validateDownloadsList(input, opts) {
    if (input === undefined)
        return undefined;
