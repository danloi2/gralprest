...
:class: important
**2.3 {term}`Parte-hartzaileak` edo {term}`Kasu Azterketa`**
:::

## 2.3. Parte-hartzaileak edo Informanteak edota Kasuaren Deskribapena

Ikerketa metodologiaren arabera, atal honek bi izen har ditzake:

- **Ikerketa kuantitatiboan**: Parte-hartzaileak (lagin ezaugarriekin)
- **Ikerketa kualitatiboan**: Informanteak edo {term}`Kasu Azterketa`ren Deskribapena

---

## Populazioa eta Lagina (Kuantitatiboa)
...
:::{tip} Lagin tamaina
Lagin tamaina kalkulatzeko `G*Power` software librea erabil daiteke.
:::

---

## Informanteak eta {term}`Kasu Azterketa` (Kualitatiboa)

**Informante egokiak** aukeratzeko irizpideak:

- Fenomenoarekin zuzeneko esperientzia izatea
- Adierazteko gai eta prest egotea
